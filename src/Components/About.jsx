    ...
    <section id="about" className="py-5">
      <div className="container bg-white">
       ...
       <div className="col-sm-6">
         ...
         <p>"I love programming, chatting, traveling and lifting heavy weight."</p>
